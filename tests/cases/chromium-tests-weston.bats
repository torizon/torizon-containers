...
# bats test_tags=platform:imx8, platform:imx95, platform:am62, platform:am62p, platform:am69, platform:upstream
@test "Chromium runs" {
  run -124 docker container exec --user torizon chromium-tests timeout 20s start-browser
}

# bats test_tags=platform:imx8, platform:imx95, platform:am62, platform:am62p, platform:am69
